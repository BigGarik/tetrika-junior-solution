def appearance(intervals: dict[str, list[int]]) -> int:
    ...
    pupil_in_lesson = merge(intersect(pupil, lesson))
    tutor_in_lesson = merge(intersect(tutor, lesson))
    common = merge(intersect(pupil_in_lesson, tutor_in_lesson))
